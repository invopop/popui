...
func Button(p props.Button) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.Form != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/button.templ`, Line: 40, Col: 16}
			}
		...
		if p.ShowSpinnerOnClick {
			var templ_7745c5c3_Var8 = []any{classes.ButtonSpinner}
...
func AnchorButton(p props.AnchorButton) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var11 = []any{templ.KV(classes.ButtonBase, p.Class == ""),
			templ.KV(p.Class, p.Class != ""),
			templ.KV(classes.ButtonDanger, p.Variant == "danger"),
			templ.KV(classes.ButtonPrimary, p.Variant == "primary"),
			templ.KV(classes.ButtonSecondary, p.Variant == "secondary"),
		...
		if p.Href != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/button.templ`, Line: 67, Col: 16}
			}
		...
		if p.Target != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/button.templ`, Line: 70, Col: 20}
			}
		...
		if p.Rel != "" {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 26, " rel=\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			var templ_7745c5c3_Var15 string
			templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.JoinStringErrs(p.Rel)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/button.templ`, Line: 73, Col: 14}
			}
		...
		if p.Type != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/button.templ`, Line: 79, Col: 16}
			}
...
func FileButton(p props.FileButton) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var18 = []any{templ.KV(classes.ButtonFile, p.Class == ""),
			templ.KV(p.Class, p.Class != ""),
		}
		...
		if p.Type != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/button.templ`, Line: 98, Col: 16}
			}
		...
		if p.Name != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/button.templ`, Line: 104, Col: 16}
			}
		...
		if p.Value != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/button.templ`, Line: 107, Col: 18}
			}
