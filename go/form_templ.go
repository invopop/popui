...
func InputError(e props.Error) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		var templ_7745c5c3_Var27 = []any{templ.KV(classes.Error, e.Class == ""), templ.KV(e.Class, e.Class != "")}
		...
		if e.Error != nil {
			...
			templ_7745c5c3_Var29, templ_7745c5c3_Err = templ.JoinStringErrs(e.Error.Error())
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/form.templ`, Line: 106, Col: 20}
			}
			...
			templ_7745c5c3_Var30, templ_7745c5c3_Err = templ.JoinStringErrs(e.Text)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `go/form.templ`, Line: 108, Col: 11}
			}
