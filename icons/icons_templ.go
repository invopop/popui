...
func Show(filename string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data, err := loadFile(ThemeDefault, filename); err == nil {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div style=\"width: 16px; height: 16px;\">")
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<!-- err with icon -->")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
